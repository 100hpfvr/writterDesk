...
mixin _$LoginStore on _LoginStore, Store {
  ...
  String toString() {
    final string =
        'passwordVisible: ${passwordVisible.toString()},loggedIn: ${loggedIn.toString()},email: ${email.toString()},password: ${password.toString()},loading: ${loading.toString()},loginPressed: ${loginPressed.toString()},isEmailValid: ${isEmailValid.toString()},isPasswordValid: ${isPasswordValid.toString()}';
    return '{$string}';
  }
}
